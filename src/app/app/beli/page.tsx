...
export default function BeliPage() {
  ...
  return (
    <div>
      ...
      {step === 1 && (
        <div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 pt-3">
            {packages.map((pkg) => {
          ...
          {availableTemplates.length === 0 ? (
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 lg:gap-5">
              {availableTemplates.map((tmpl) => (
                ...
                >
                  <div className="h-24 sm:h-36 lg:h-48 bg-gradient-to-br from-cream-200 to-cream-300 flex items-center justify-center relative group overflow-hidden">
                    {tmpl.thumbnail ? (
