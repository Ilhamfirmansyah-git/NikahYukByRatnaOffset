    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl border border-cream-200 p-6">
          ...
          <p className="text-xs text-gray-400 mt-1">kunjungan ke undangan</p>
        </div>
              ...
              <div key={inv.id} className="p-6 flex items-center justify-between hover:bg-cream-50 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">/{inv.slug} · {inv.rsvps.length} RSVP · {inv._count.visits} kunjungan</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
