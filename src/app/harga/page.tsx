...
const pricingTiers = [
  {
    ...
    features: {
      "Template pilihan": "1 template",
      "Masa aktif": "30 hari",
      "RSVP online": true,
      "Buku tamu digital": true,
      "Link undangan unik": true,
      "Countdown timer": true,
      "Musik latar belakang": false,
      "Galeri foto & video": false,
      "Peta lokasi interaktif": false,
      "Manajemen tamu VIP": false,
      "Custom domain": false,
      "Prioritas support": false,
      "Live streaming integration": false,
  ...
  },
  {
    ...
    features: {
      ...
      "Galeri foto & video": true,
      "Peta lokasi interaktif": true,
      "Manajemen tamu VIP": true,
      "Custom domain": false,
      "Prioritas support": false,
      "Live streaming integration": false,
      "Digital angpao": false,
  ...
  },
  {
    ...
    features: {
      "Template pilihan": "Semua template + custom",
      "Masa aktif": "90 hari",
      "RSVP online": true,
      "Buku tamu digital": true,
      "Link undangan unik": true,
      ...
      "Live streaming integration": true,
      "Digital angpao": true,
    },
  },
];
